...
categories:
  - Claude Code
source: https://github.com/huangguang1999/ccstatusline-zh
---

> **转载声明**：本文转载自 [ccstatusline-zh - Claude Code 汉化状态栏的配置实践](https://github.com/huangguang1999/ccstatusline-zh)，著作权归原作者所有。
